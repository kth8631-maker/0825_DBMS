 ...
 * 
 * 별칠에 특수문자 또는 공백문자가 포함될 경우 반드시 ""로 묶어주어야함
 */
 ...
 * 
 * 주의) SELELCT에 DISTINCT구문은 한 개만 사용이 가능
 */
...
-- 실행순서 1. FROM -> 2. WHERE -> SELECT (합리적)
-----------------------------------------------
/*
 * <실습>
 */
...
-- 4. EMPLOYEE테이블로부터 해외영업과 관련된 부서들의 부서명 조회
SELECT 
       DEPT_TITLE
  FROM 
       DEPARTMENT
